...
- [ ] 40. Let write-enabled workflows idempotently synchronize managed documents and their complete attachment sets by stable source key, using standard Markdown links while preserving legacy embeds.
...
- [ ] Run backend, API-contract, security, frontend, accessibility, and responsive browser verification for items 39 and 40.
